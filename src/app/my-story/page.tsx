...
export default function MyStory() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-[#FCFBF8] via-[#FDFBF7] to-[#F7F3EB] text-[#8c6239]">
        ...
        <div className="max-w-3xl mx-auto text-center space-y-8 relative z-10">
          <div className="space-y-6">
            <div>
              ...
              <h2 className="text-4xl md:text-5xl font-playfair font-bold text-[#8c6239] leading-tight mb-4">
            ...
            <div className="space-y-6 text-base md:text-lg text-[#8c6239]/75 font-medium leading-relaxed max-w-2xl mx-auto text-center">
              <p>
      ...
      {/* Connect Section */}
      <section id="contact" className="bg-[#FFFDF6] py-24 text-[#8c6239] overflow-hidden relative border-t border-brand/5 shadow-sm">
        ...
        <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16 items-center relative z-10">
          <div>
            ...
            <div className="space-y-6">
              <a href="mailto:dryfishbasket2627@gmail.com" className="flex items-center gap-6 group">
                <div className="w-12 h-12 rounded-2xl bg-[#8c6239]/5 flex items-center justify-center group-hover:bg-[#C5A059] transition-all duration-500">
                  <Mail size={20} className="text-[#C5A059] group-hover:text-white" />
                </div>
                <div>
                  <p className="text-[10px] font-black uppercase tracking-widest text-[#8c6239]/40">Email Us</p>
                  <p className="text-lg font-bold text-[#8c6239]">dryfishbasket2627@gmail.com</p>
                </div>
              </a>
              ...
              <div className="flex items-center gap-6 group">
                ...
                <div>
                  <p className="text-[10px] font-black uppercase tracking-widest text-[#8c6239]/40">Call Us</p>
                  <p className="text-lg font-bold text-[#8c6239]">+91 63649 36047</p>
                </div>
              </div>

              <a href="https://wa.me/916364936047" target="_blank" rel="noopener noreferrer" className="flex items-center gap-6 group">
                <div className="w-12 h-12 rounded-2xl bg-[#8c6239]/5 flex items-center justify-center group-hover:bg-[#25D366] transition-all duration-500">
                  <MessageCircle size={20} className="text-[#C5A059] group-hover:text-white" />
                </div>
                <div>
                  <p className="text-[10px] font-black uppercase tracking-widest text-[#8c6239]/40">WhatsApp Us</p>
                  <p className="text-lg font-bold text-[#8c6239]">+91 63649 36047</p>
                </div>
              </a>
            </div>
          ...
          <div className="bg-white p-12 rounded-[3rem] border border-brand/10 backdrop-blur-md shadow-sm">
            <h4 className="text-xl font-playfair font-bold mb-8 text-[#8c6239]">Follow Our Journey</h4>
            <div className="grid grid-cols-2 gap-4">
              <a 
                href="https://www.instagram.com/dryfishbasket_store?igsh=MWpucWdvdWFmbzJnZA%3D%3D&utm_source=qr" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="flex items-center justify-center gap-3 p-4 bg-[#8c6239]/5 text-[#8c6239] hover:text-white rounded-2xl hover:bg-[#C5A059] transition-all group"
              >
                <Camera size={20} />
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer" 
                className="flex items-center justify-center gap-3 p-4 bg-[#8c6239]/5 text-[#8c6239] hover:text-white rounded-2xl hover:bg-brand-dark transition-all group"
              >
                <Share2 size={20} />
                <span className="text-xs font-bold uppercase tracking-widest">Facebook</span>
              </a>
              <a href="#" className="flex items-center justify-center gap-3 p-4 bg-[#8c6239]/5 text-[#8c6239] hover:text-white rounded-2xl hover:bg-blue-400 transition-all group">
                <Send size={20} />
                <span className="text-xs font-bold uppercase tracking-widest">Twitter</span>
              </a>
              <div className="p-4 bg-[#8c6239]/5 rounded-2xl flex items-center justify-center text-[10px] font-black uppercase tracking-[0.2em] text-[#8c6239]/30">
                More Coming Soon
              </div>
            </div>
          </div>
