    ...
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full">
        <div className="py-32 text-center bg-[#FFFDF6] rounded-[3rem] border border-[#064e3b]/5 shadow-sm max-w-xl mx-auto px-8">
          ...
          <Link 
            href="/" 
            className="inline-block px-10 py-4 bg-[#eab308] text-[#064e3b] rounded-xl font-bold uppercase tracking-widest text-xs hover:bg-[#32451B] transition-all shadow-md"
          >
          ...
          <>
            ...
            >
              ...
              <div className="pt-4 border-t border-[#064e3b]/5 mt-auto flex gap-4 flex-shrink-0 bg-[#FFFDF6]">
                ...
                <button
                  onClick={() => setIsMobileFiltersOpen(false)}
                  className="flex-[2] py-3.5 rounded-xl bg-[#eab308] text-[#064e3b] text-xs font-black uppercase tracking-widest shadow-lg active:scale-95 transition-all cursor-pointer text-center"
                >
                  Apply & Close
                </button>
              </div>
