            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-5 shadow-sm space-y-3 text-brand-dark max-w-sm hover:-translate-y-1.5 hover:shadow-md hover:border-brand/20 transition-all duration-300">
              ...
              <div className="border-t border-gray-200 pt-4 mt-2 flex items-center justify-between gap-4">
                ...
                <button
                  ...
                  className="flex items-center justify-center px-6 py-3 bg-[#eab308] text-[#064e3b] hover:bg-[#043d2e] hover:text-white font-bold text-xs uppercase tracking-wider rounded-xl transition-all duration-300 shadow-md shadow-[#eab308]/20 hover:shadow-lg hover:-translate-y-1 active:translate-y-0 cursor-pointer"
                >
                  Register Now
                </button>
              </div>
  ...
  const handleRegisterSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        // Formulate WhatsApp message to send to 6364936047
        const formattedMsg = `Hello Dry Fish Basket! I have registered for the event:
...
${regNotes ? `*Notes:* ${regNotes}` : ""}`;
        ...
        const whatsappUrl = `https://api.whatsapp.com/send?phone=916364936047&text=${encodedMsg}`;
