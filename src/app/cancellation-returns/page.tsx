...
export const metadata = {
  title: "Cancellation & Returns - Dry Fish Basket",
  description: "Cancellation and returns information for Dry Fish Basket premium products.",
};
    ...
    <div className="min-h-[70vh] bg-gradient-to-br from-[#FCFBF8] via-[#FDFBF7] to-[#F7F3EB] py-16 px-6">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-[#FFFDF6] p-8 md:p-12 rounded-[2.5rem] border border-brand/5 shadow-sm text-center">
          <div className="w-16 h-16 rounded-full bg-[#8c6239]/5 flex items-center justify-center mx-auto mb-6">
            <RotateCcw size={32} className="text-[#C5A059]" />
          </div>
          
          <h2 className="text-2xl font-playfair font-bold text-[#8c6239] mb-4">Under Construction</h2>
          <p className="text-lg text-[#8c6239]/70 font-medium leading-relaxed max-w-lg mx-auto mb-8">
          ...
          <div className="pt-6 border-t border-brand/5 max-w-md mx-auto">
            <p className="text-sm text-[#8c6239]/60 font-semibold mb-2">Have questions in the meantime?</p>
            <p className="text-base font-bold text-[#8c6239]">
              Contact us at{" "}
