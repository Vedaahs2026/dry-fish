                  ...
                  <div className="pt-3 pb-3 px-3 flex flex-col flex-1">
                    ...
                    {item.totalStock === 0 ? (
                      <Link
                        ...
                        className="w-full mt-auto flex items-center justify-center space-x-2 font-bold py-3.5 rounded-2xl transition-all text-xs tracking-wider uppercase shadow-md bg-[#eab308] text-[#064e3b] hover:bg-[#ca8a04] border border-transparent hover:border-brand-accent/20 cursor-pointer"
                      >
